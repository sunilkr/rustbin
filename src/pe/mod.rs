...
use std::{io::{BufReader, Result, Seek, SeekFrom, Error, Read}, fs::File};

use byteorder::{LittleEndian, ReadBytesExt};

use crate::types::{HeaderField, Header};

use self::{dos::DosHeader, file::FileHeader, optional::{ImageType, OptionalHeader, x86::OptionalHeader32, x64::OptionalHeader64, DataDirectory, HEADER_LENGTH_32, HEADER_LENGTH_64, DATA_DIRS_LENGTH, parse_data_directories}};
...
impl Header for PeImage {
    fn parse_file(f: &mut BufReader<File>, pos: u64) -> Result<Self> where Self: Sized {
        ...
        let data_dir_hdr = HeaderField {value:data_dirs, offset: new_pos, rva: new_pos};
...
mod tests {
    ...
    use crate::{types::Header, pe::optional::{OptionalHeader, ImageType, MAX_DIRS, DirectoryType}};
    ...
    const  RAW_BYTES_64: [u8; 704] = [
        ...
        0x47, 0xF2, 0xAE, 0x04, 0xEB, 0xF2, 0xAF, 0x04, 0x47, 0xF2, 0xAF, 0x04, 0xDD, 0xF2, 0xAF, 0x04,
        0x91, 0x86, 0xAD, 0x05, 0x46, 0xF2, 0xAF, 0x04, 0x52, 0x69, 0x63, 0x68, 0x47, 0xF2, 0xAF, 0x04,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x50, 0x45, 0x00, 0x00, 0x64, 0x86, 0x05, 0x00, 0x91, 0xC0, 0x02, 0x62, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xF0, 0x00, 0x22, 0x00, 0x0B, 0x02, 0x0E, 0x1C, 0x00, 0x2A, 0x04, 0x00,
        0x00, 0x58, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF4, 0x1D, 0x04, 0x00, 0x00, 0x10, 0x00, 0x00,
        ...
        ,
